  ...
  const KEYCLOAK_FORM_FIELDS: TControllerInputFormField[] = [
    {
      ...
      description: (
        <>
          The base URL of your Keycloak server, without a trailing slash. Example:{" "}
          <CodeBlock darkerShade>https://keycloak.example.com</CodeBlock>.
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          The Keycloak realm that contains your Plane client. Example: <CodeBlock darkerShade>master</CodeBlock>.
        </>
      ),
      placeholder: "master",
    ...
    },
    {
      ...
      type: "text",
      label: "Client ID",
      description: <>The client ID of the OpenID Connect client you created in your Keycloak realm for Plane.</>,
      placeholder: "plane",
    ...
    },
    {
      ...
      label: "Client secret",
      description: (
        <>The client secret from your Keycloak client&apos;s Credentials tab. Only required for confidential clients.</>
      ),
      placeholder: "********************************",
  ...
  const KEYCLOAK_SERVICE_FIELD: TCopyField[] = [
    {
      ...
      description: (
        <>
          We will auto-generate this. Paste this into the <CodeBlock darkerShade>Valid Redirect URIs</CodeBlock> field
          of your Keycloak client settings.
        </>
      ),
    },
  ];
